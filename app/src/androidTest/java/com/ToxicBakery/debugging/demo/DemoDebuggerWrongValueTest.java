...
@LargeTest
public class DemoDebuggerWrongValueTest {

    @Rule
    public ActivityTestRule<DemoDebuggerWrongValue> activityTestRule
            = new ActivityTestRule<>(DemoDebuggerWrongValue.class);
