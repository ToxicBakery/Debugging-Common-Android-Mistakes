...
@LargeTest
public class DemoDebuggerTooManyThreadsTest {

    @Rule
    public ActivityTestRule<DemoDebuggerTooManyThreads> activityTestRule
            = new ActivityTestRule<>(DemoDebuggerTooManyThreads.class);
